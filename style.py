...
#    print m+"+--------------------------------------+"
    os.system("echo '|  Author: RED-MAFIA   ' | lolcat")
    os.system("echo '|  Team: Life Of Programmer' | lolcat")
    os.system("echo '|  Instagram: NAHI HAI' | lolcat")
    os.system("echo '|  Facebook: RED-MAFIA  ' | lolcat")
    print m+"+------------------------------------------------+ "
...
def eyes_gay():
    ...
    os.system("toilet -f standard '   Eyes Gay' -F gay")
    os.system("echo '            Powered By: RED-MAFIA' | lolcat")
    print ' '
    runntxt(a+"                √  S U C C E S ✓")
    runntxt(h+"          ✓  Silahkan Buka Sesi Baru ✓")
    print " "
